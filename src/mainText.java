...
//        IServiceRecord serviceRecord = emergencyService.createRecord(name,phoneNumber,date);
//        System.out.println(serviceRecord.getRecordTime());
    ...
    private static KeyValue whatToUpdate(KeyValue record){
        ...
        }while (choice!=updateOptions.length);
        return record;
    }
